...
"""
figpath = "examples/test_pic/test_exp/distance_ws/farms_"#angle_variance_wd/
csv_file_path = 'exp2-distance-ws.csv'
length = 2000.0
...
def main():
    ...
    angle_range = [90,]# 270] # np.arange(0, 360, 45) # 8
    distance_range = np.arange(length, length*2, 200) # 10 [2000, 2500, 3000] # 
    repeat_times = 3
